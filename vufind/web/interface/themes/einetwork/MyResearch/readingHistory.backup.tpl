						...
						<div>
							...
							<div id="readingListActionsTop">
								{if $historyActive == true}
									...
									{/if}
									{*<input class="button" onclick='return exportListAction();' value="Export To Excel">*}
									<input class="button" onclick='return optOutAction({if $transList}true{else}false{/if})' value="Stop Recording My Reading History">
