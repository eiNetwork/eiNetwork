  ...
  <div id="main-content">
	...
	{section name=resultsPageViewsRow loop=$resultsPageViews} 
	  <tr {if $smarty.section.nr.iteration is odd} bgcolor="#efefef"{/if}> 
	    <td>{$resultsPageViews[resultsPageViewsRow].Location}</td> 
	    <td>{$resultsPageViews[resultsPageViewsRow].PageViews}</td> 
	    <td>{$resultsPageViews[resultsPageViewsRow].Holds}</td> 
	    <td>{$resultsPageViews[resultsPageViewsRow].Renewals}</td> 
	  </tr> 
	{sectionelse} 
