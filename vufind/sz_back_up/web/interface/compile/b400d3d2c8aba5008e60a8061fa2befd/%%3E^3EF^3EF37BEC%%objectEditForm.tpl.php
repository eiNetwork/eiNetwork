...
<form id='objectEditor' method="post" <?php if ($this->_tpl_vars['contentType']): ?>enctype="<?php echo $this->_tpl_vars['contentType']; ?>
"<?php endif; ?> action="<?php echo $this->_tpl_vars['submitUrl']; ?>
">
  <?php echo '
