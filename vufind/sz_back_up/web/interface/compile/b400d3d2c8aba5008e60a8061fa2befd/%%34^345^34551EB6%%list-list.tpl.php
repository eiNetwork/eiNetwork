<?php /* Smarty version 2.6.19, created on 2012-06-20 12:21:17
         compiled from Search/list-list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'Search/list-list.tpl', 52, false),)), $this); ?>
...
?>
		  <div class="result <?php if (( $this->_foreach['recordLoop']['iteration'] % 2 ) == 0): ?>alt<?php endif; ?> record<?php echo $this->_foreach['recordLoop']['iteration']; ?>
">
