<?php /* Smarty version 2.6.19, created on 2012-06-20 11:06:25
         compiled from Record/view.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'Record/view.tpl', 2, false),array('modifier', 'trim', 'Record/view.tpl', 37, false),array('modifier', 'lower', 'Record/view.tpl', 67, false),array('modifier', 'regex_replace', 'Record/view.tpl', 67, false),array('modifier', 'formatISBN', 'Record/view.tpl', 217, false),array('modifier', 'truncate', 'Record/view.tpl', 229, false),array('modifier', 'stripTags', 'Record/view.tpl', 354, false),array('function', 'translate', 'Record/view.tpl', 34, false),)), $this); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['internetLink']['linkText'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
		...
		<?php endif; ?>
				...
				<?php if ($this->_tpl_vars['enablePurchaseLinks'] == 1 && ! $this->_tpl_vars['purchaseLinks']): ?>
					<div class='purchaseTitle button'><a href="#" onclick="return showPurchaseOptions('<?php echo $this->_tpl_vars['id']; ?>
