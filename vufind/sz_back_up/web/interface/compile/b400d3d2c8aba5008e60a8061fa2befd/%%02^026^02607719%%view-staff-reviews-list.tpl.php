<?php /* Smarty version 2.6.19, created on 2012-06-20 11:06:25
         compiled from Record/view-staff-reviews-list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'Record/view-staff-reviews-list.tpl', 5, false),array('modifier', 'escape', 'Record/view-staff-reviews-list.tpl', 7, false),array('function', 'translate', 'Record/view-staff-reviews-list.tpl', 7, false),)), $this); ?>
<h4>Staff Reviews</h4>
<?php $_from = $this->_tpl_vars['staffCommentList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
	...
	<div class='comment'>
		<div class="commentHeader">
			<div class='commentDate'><?php echo ((is_array($_tmp=$this->_tpl_vars['comment']->created)) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
				...
				<span onclick='deleteComment(<?php echo ((is_array($_tmp=$this->_tpl_vars['id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
...
<?php endforeach; else: ?>
	<div><?php echo translate(array('text' => 'No staff reviews have been posted yet'), $this);?>
.</div>
