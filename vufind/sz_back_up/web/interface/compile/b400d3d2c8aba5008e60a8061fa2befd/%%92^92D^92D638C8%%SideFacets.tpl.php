...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'Search/Recommend/SideFacets.tpl', 3, false),array('modifier', 'escape', 'Search/Recommend/SideFacets.tpl', 10, false),array('modifier', 'translate', 'Search/Recommend/SideFacets.tpl', 79, false),)), $this); ?>
<?php if ($this->_tpl_vars['recordCount'] > 0 || $this->_tpl_vars['filterList'] || ( $this->_tpl_vars['sideFacetSet'] && $this->_tpl_vars['recordCount'] > 0 )): ?>
<div class="sidegroup">
	<h4><?php echo translate(array('text' => 'Narrow Search'), $this);?>
</h4>
...
';" />
					...
					<td>
						<?php echo translate(array('text' => $this->_tpl_vars['current']['desc']), $this);?>
<br />
					</td>
				</tr>
...
/images/silk/delete.png" alt="Delete"/></a></li>
			<?php endforeach; endif; unset($_from); ?>
		<?php endforeach; endif; unset($_from); ?>
		</ul>
	<?php endif; ?>
...
?>
 ...
 <img src="<?php echo $this->_tpl_vars['path']; ?>
/images/silk/tick.png" alt="Selected" /> <a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['thisFacet']['removalUrl'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" class="removeFacetLink">(remove)</a></dd>
							<?php else: ?>
...
" class="removeFacetLink">(remove)</a></dd>
						...
						<?php else: ?>
							<?php if ($this->_tpl_vars['curLabel'] == 'Unrated'): ?>
								<dd><?php if ($this->_tpl_vars['thisFacet']['url'] != null): ?><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['thisFacet']['url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php if ($this->_tpl_vars['thisFacet']['url'] != null): ?></a><?php endif; ?> <?php if ($this->_tpl_vars['thisFacet']['count'] != ''): ?>(<?php echo $this->_tpl_vars['thisFacet']['count']; ?>
						...
						<?php endif; ?>
					<?php endforeach; endif; unset($_from); ?>
					<?php if ($this->_foreach['narrowLoop']['total'] > $this->_tpl_vars['cluster']['valuesToShow']): ?><dd><a href="#" onclick="lessFacets('<?php echo $this->_tpl_vars['title']; ?>
